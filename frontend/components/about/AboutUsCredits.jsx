            ...
            <div className={"flex flex-col md:grid md:grid-cols-3 gap-x-5"}>
                <div>
                    ...
                    sequence={[
                        ...
                        deletionSpeed={25}
                    />
                    <h3 className={supremeBold.className + " text-2xl font-bold text-stone-700 pb-1 font-semibold"}>from Shiva & Team</h3>
                    <h3 className={supremeBold.className + " text-xl font-bold text-stone-500 font-semibold"}>Founder and developer of Navigator</h3>
                </div>
