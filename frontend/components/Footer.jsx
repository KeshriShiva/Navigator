        ...
        <div>
            <div className={supremeRegular.className + " flex flex-col md:flex-row bg-stone-800 h-full md:h-52 py-8 md:pl-28 max-md:px-14 gap-x-24"}>
                <span className="md:ml-12 text-stone-200 max-md:mb-6">
                    <h2 className={albula.className + " max-md:text-lg mb-1"}>Navigator</h2>
                    <div className={"max-md:w-full w-56 leading-snug"}>Navigator is here to help you confidently navigate the world of travel visas. Check the latest visa reqiurements for 197+ countries.</div>
                </span>
                ...
                <div>
                    ...
                    <li className={"text-stone-200 hover:text-stone-500 font-medium list-none pb-3"}>
                        <Link href="/about">Navigator</Link>
                    </li>
                    <li className={"text-stone-200 hover:text-stone-500 font-medium list-none pb-3"}>
            ...
            <div className={"bg-stone-800 md:pl-28 pl-12 pb-4"}>
                <span className={"md:ml-12 text-stone-200 text-xs mt-10 md:mt-16"}>© {new Date().getFullYear()} Navigator.com. All rights reserved.</span>
            </div> 
        </div>
    );
}
